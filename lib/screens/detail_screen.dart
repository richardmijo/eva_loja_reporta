...
class DetailScreen extends StatelessWidget {
  ...
  DetailScreen({super.key, required this.incident});

  final ValueNotifier<bool> favoritoNotifier = ValueNotifier<bool>(false);
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          ValueListenableBuilder<bool>(
            valueListenable: favoritoNotifier,
            builder: (context, favorito, child) {
              return IconButton(
                ...
                onPressed: () => favoritoNotifier.value = !favoritoNotifier.value,
              );
            },
          ),
        ],
